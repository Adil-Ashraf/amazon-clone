...
gem "pundit"
# Lightweight, fast pagination with minimal dependencies [https://github.com/ddnexus/pagy]
gem "pagy"
...
group :development, :test do
  ...
  # Test framework and test data [https://rspec.info, https://github.com/thoughtbot/factory_bot_rails]
  gem "rspec-rails"
...
group :development do
  ...
  # Generates a production-ready Dockerfile [https://github.com/fly-apps/dockerfile-rails]
